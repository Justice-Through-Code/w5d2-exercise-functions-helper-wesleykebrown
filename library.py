...
'''The structure of the data in books_with_details
is a list of dictionaries
with a key values set as data types of strings'''
...
#number_of_available_books = count_books()
#print(number_of_available_books)
...
#author_search_list = search_by_author('Yuval Noah Harari')
#print(author_search_list)